...
def audit_name_to_fstype(*args):
  return _audit.audit_name_to_fstype(*args)
audit_name_to_fstype = _audit.audit_name_to_fstype

def audit_fstype_to_name(*args):
  return _audit.audit_fstype_to_name(*args)
...
def audit_set_backlog_wait_time(*args):
  return _audit.audit_set_backlog_wait_time(*args)
audit_set_backlog_wait_time = _audit.audit_set_backlog_wait_time

def audit_reset_lost(*args):
  return _audit.audit_reset_lost(*args)
